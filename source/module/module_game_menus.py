    ...
    [
      ...
      ("camp_wait_here",[],"Wait here for some time.",
       [
           ...
           (rest_for_hours_interactive, 24 * 365, 5, 0), #rest while attackable // not attackable #VEXED
  ...
  ("camp_recruit_prisoners",0,
   ...
   [(assign, ":num_regular_prisoner_slots", 0),
    ...
    (else_try),
      ...
      (store_random_in_range, ":rand", 36, 100), #modifier for recruiting a prisoner successfully
    ...
    [
      ("camp_recruit_prisoners_accept",[(gt, "$g_prisoner_recruit_troop_id", 0)],"Take them.",
       [(remove_troops_from_prisoners, "$g_prisoner_recruit_troop_id", "$g_prisoner_recruit_size"),
        ...
        (store_mul, ":morale_change", 0, "$g_prisoner_recruit_size"),
      ...
      (try_for_range, ":unused", 0, ":end_cond"),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (str_store_string, s0, "@Some of your tendons have been damaged in the battle. You lose NO strength."),
          (else_try),
            (eq, ":random_attribute", ca_agility),
            (str_store_string, s0, "@You took a nasty wound which will cause you to limp slightly even after it heals. You lose NO agility."),
##          (else_try),
...
##            (eq, ":random_attribute", ca_intelligence),
            (str_store_string, s0, "@You have trouble thinking straight after the battle, perhaps from a particularly hard hit to your head, and frequent headaches now plague your existence. Your intelligence is NOT reduced."),
          (try_end),
        (else_try),
          (lt, ":end_cond", 200),
          (val_add, ":end_cond", 1),
      ...
      (try_begin),
        ...
        (try_end),
      (else_try),
        (troop_raise_attribute, "trp_player", ":random_attribute", 0),
      (try_end),
      ],
    [
      ("s0",
  ...
  (
    ...
    [
        ...
        (try_begin),
          ...
          (store_random_in_range, "$qst_eliminate_bandits_infesting_village_num_villagers", 25, 51),
       ...
       [(party_slot_eq, "$current_town", slot_center_has_manor, 1),
        (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
         ...
         [
           ...
           (rest_for_hours_interactive, 24 * 7, 5, 0), #rest while attackable // cannot be attacked
...
############################################################################################################################
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} denars. {s8}",
    ...
    [
        ...
        (assign, reg9, 10000), ## TOURNAMENT DENAR PAYOUT
    ...
    [
      ("continue",[], "Continue...",
       [         
		 ...
		 (assign, "$g_skip_starting_quest", 0),
...
What kind of recruits do you want?",
   ...
   ("recruiter_faction_6", [(eq, "$recruiter_amount_check", 0)],
         "Sarranid",              [(assign,"$temp","fac_kingdom_6"),(jump_to_menu, "mnu_recruiter_payment_2")]),

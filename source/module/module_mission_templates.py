...
AI_kick =  (
	...
	(try_for_agents, ":agent"),
		...
		#Check chance
		(store_random_in_range,":kickchance", 5, 10),
		(try_begin),
			(eq,":kickchance",5), #50% chance per check
			    #DEBUG#(display_message, "@Agent kicks."), #DEBUG#
...
common_start_deathcam = (
    ...
    [
		...
		(display_message, "@Use Backspace to command your army"),
